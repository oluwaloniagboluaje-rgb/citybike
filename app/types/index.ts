...
/**
 * Unified customer-facing tracking event source.
 */
...
/**
 * Unified tracking event used by the customer tracking page.
 *
 * This supports:
 *
 * - Local shipments
...
/**
 * Public customer tracking response.
 */
export interface PublicTrackingResult {
  ...
  /**
   * Normal CityBike shipment history.
   */
  statusHistory: {
    status: OrderStatus;
    at: string;
   ...
   *
   * This allows international cargo to appear
   * in the same style as DHL tracking.
   */
  trackingEvents: TrackingEvent[];
...
export const DHL_STATUS_LABELS: Record<
  DHLStatus,
  string
> = {
  shipment_picked_up:
